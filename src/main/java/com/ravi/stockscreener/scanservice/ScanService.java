...
public class ScanService {
    ...
    private @NonNull Single<Triple<Num, Num, Operand>> getIndicator(UpstoxInstrument upstoxInstrument, Operand operand) {
        if (operand instanceof InputsOperand inputsOperand) {
            ...
            return RxJava3Adapter.monoToSingle(ensureCandleData(upstoxInstrument, operand.getTimeframe())
                    .map(barSeries -> {
    ...
    private Mono<BaseBarSeries> ensureCandleData(UpstoxInstrument upstoxInstrument, String timeframe) {
